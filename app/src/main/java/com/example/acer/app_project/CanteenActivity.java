...
public class CanteenActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://it2.sut.ac.th/script259g5/App/canteen.php?namegruop="+sp.getString("id_group", "");

        //String url = "http://it2.sut.ac.th/script259g5/App/canteen.php?namegruop=qsOSroLHAT";
        ...
        try {
            ...
            for(int i = 0; i < data.length(); i++){
                ...
                map.put("ct_name", c.getString("ct_name"));
            ...
            simpleAdapterData = new SimpleAdapter(CanteenActivity.this, MyArrList, R.layout.acivity_column3,
                    new String[] {"id-m", "ct_name"}, new int[] {R.id.articleID, R.id.articleTitle});
        ...
        listViewMovies.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long rowId) {
                ...
                adb.setTitle("ข้อมูลโรงอาหาร");
                adb.setMessage("ชื่อโรงอาหาร: " + MyArrList.get(position).get("ct_name") + "\n"
                        + "จำนวน: " +  MyArrList.get(position).get("capacity") + " คน\n"
                );
